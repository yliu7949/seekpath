...
elseif strcmp(bravaisLatticeType, 'aP')
    ...
    reciprocalLattice = seekpath.utils.getReciprocalCellRows(conventionalLattice);
    ...
    reducedLattice = seekpath.utils.getRealCellFromReciprocalRows(reducedReciprocalLattice);

    % Get the cell parameters of the reduced reciprocal lattice
    [ka2, kb2, kc2, cosKalpha2, cosKbeta2, cosKgamma2] = seekpath.utils.getCellParameters(reducedReciprocalLattice);
    ...
    reciprocalCell3 = seekpath.utils.getReciprocalCellRows(realCell3);

    % Get cell parameters
    [~, ~, ~, cosKalpha3, cosKbeta3, cosKgamma3] = seekpath.utils.getCellParameters(reciprocalCell3);
    ...
    reciprocalCellFinal = seekpath.utils.getReciprocalCellRows(realCellFinal);

    % Get cell parameters
    [~, ~, ~, cosKalpha, cosKbeta, cosKgamma] = seekpath.utils.getCellParameters(reciprocalCellFinal);
